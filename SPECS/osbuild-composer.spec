...
Patch1:               0001-Add-Rocky-Linux-8-and-9-Support.patch
...
%changelog
* Wed May 09 2024 Matt Hink <mhink@ciq.com> - 75-1.0.3
- Rebuild with new golang.
- CVE-2024-1394 CVE-2024-34156

* Tue May 16 2023 Release Engineering <releng@rockylinux.org> - 75-1.rocky.0.2
- Add Rocky Linux 8 support and host detection
- Add Rocky Linux 9 support and host detection
