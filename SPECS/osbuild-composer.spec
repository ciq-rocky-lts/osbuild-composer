...
Patch1:               0001-Add-Rocky-8-Support.patch
...
%changelog
* Sun Oct 02 2022 Matt Hink <mhink@ciq.com> - 46.3-2
- Rebuild with new golang CVE-2024-34156

* Sun Oct 02 2022 Release Engineering <releng@rockylinux.org> - 46.3-1.rocky.0.2
- Add Rocky Linux 8 support
- Add Rocky Linux 8 host detection
